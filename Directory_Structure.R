...
# 
# Author:  Brad
# File:    Dirctory_Structure.R
# Version: 1.0
# Date:    02.5.2014
# Purpose: This program creates the directory structure of the online Edgar archives 
###############################################################################
...
external_packages <- c("gdata","memoise","plyr","RCurl","XML")
invisible(unlist(sapply(external_packages,load_external_packages, repo_str=repo, simplify=FALSE, USE.NAMES=FALSE)))
installed_packages <- list_installed_packages(external_packages)
#c("chron","DataCombine","RJDBC")
...
cik_catalog_temp <- read.csv(file=paste(output_directory,downloadfolder,"CIK_list.csv",sep="/"),header=TRUE,na.strings="NA",stringsAsFactors=FALSE)
